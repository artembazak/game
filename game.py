...
class Game:
    ...
    def print_end_game_message(self, блин_проиграл: bool, player_win: bool):
        if блин_проиграл and player_win:
            text = FONT.render('You Won!', True, Game.BLACK_COLOR)
        elif блин_проиграл and player_win == False:
    ...
    def run_game_loop(self):
        ...
        while not блин_проиграл:
            ...
            if player.detect_collision(enemy1):
                блин_проиграл = True
                player_win = False
                self.print_end_game_message(блин_проиграл, player_win)
                break
